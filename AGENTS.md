...
2. Deterministic Node code renders committed static HTML under `site/`.

Agents may edit `repositories.md`, `DESIGN.md`, `PLAN.md`, `wiki/index.md`,
`wiki/log.md`, and `wiki/<repo>/*.md`.
...
Commit the Markdown/design changes and regenerated `site/` output together.
